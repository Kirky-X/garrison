...
//!
//! 展示：
//! 1. HttpDigestAuth 构造与 WWW-Authenticate 质询头生成
//! 2. compute_ha1 预计算摘要（避免框架持有明文密码）
//! 3. validate 校验客户端 Authorization header（qop=auth 流程）
//!
//! 运行方式：
//! ```sh
//! cargo run --example httpdigest_login --features secure-httpdigest
//! ```
