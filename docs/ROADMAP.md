...
**里程碑意义**：关闭所有 Sa-Token 对标剩余 gap，remember_me / 身份切换 / Token 置换 / OAuth2 注解 / 路由分组 / 会话过期回调 / SAML 2.0 / OIDC RP / Redis pub/sub SsoChannel 十一大能力悉数就位。
...
- 错误类型统一：全代码库使用 `BulwarkError` / `BulwarkResult`
