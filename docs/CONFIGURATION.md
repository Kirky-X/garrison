...
| 中 | toml 文件 | 通过 `GarrisonConfig::load(Some(path))` 加载 toml 文件（基于 confers 0.4） |
...
| `replaced_login_exit_mode` | `String` | `"OldDevice"` | `GARRISON_REPLACED_LOGIN_EXIT_MODE` | 顶人下线策略 |
