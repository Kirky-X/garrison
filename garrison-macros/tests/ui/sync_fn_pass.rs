...
fn main() {
    ...
    let _ = sync_mfa_handler;
    let _ = sync_disable_handler;
    let _ = sync_abac_handler;
    let _ = sync_abac_default_resource_handler;
}
