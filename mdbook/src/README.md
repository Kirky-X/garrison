...
<p align="center">
  <img src="./assets/logo.png" alt="Garrison Logo" width="160" />
</p>

# Garrison 简介

Garrison 是一个面向 Rust 生态的身份认证鉴权框架，目标是提供开箱即用的认证、授权、会话与协议层能力。
...
- **0.5.1~0.5.3**：RBAC 实体 / UserDevice / 权限注册表 / 请求对象 API / miette 富错误 / 显式 Manager API / GarrisonLogic trait 拆分 / LoginId newtype 删除 / oxcache 升级 / MySQL 后端 / Firewall MaxMindDb 生产后端
