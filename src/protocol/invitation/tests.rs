...
//!
//! 覆盖：码生成与规范化、签发、只读校验、原子消费、
//! 防爆破锁定、吊销与列出、事件广播、注册编排钩子。

use super::*;
// 事件广播测试依赖 listener feature（未启用时相关测试编译剔除）
...
// ============================================================================
// 事件变体与广播（listener/mod.rs + audit.rs）
// ============================================================================
...
// ============================================================================
// create / create_batch（handler.rs）
// ============================================================================
...
// ============================================================================
// redeem 原子消费（handler.rs，check-and-restore）
// ============================================================================
...
// ============================================================================
// 注册编排钩子 InvitationRedeemHook（mod.rs + handler.rs）
// ============================================================================
...
// ============================================================================
// 覆盖率补齐（consumable 便捷方法 / 脏数据防御分支 / 碰撞重试 / 批量广播）
// ============================================================================
