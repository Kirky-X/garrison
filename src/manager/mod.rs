...
// 工厂子系统（BulwarkLogicFactoryContext / BulwarkLogicFactoryEntry / bulwark_logic_factory_default）。
pub mod factory;
// BulwarkManager 实现块（含 Drop impl）与 factory selector 辅助函数。
pub mod impls;

// Re-export factory 公共 API（保持原 mod.rs 路径兼容，如 crate::manager::BulwarkLogicFactoryEntry）。
pub use factory::*;
